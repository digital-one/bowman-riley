...
if(get_field('awards')): ?>
<ul id="awards-list">
<?php while(the_repeater_field('awards')): ?>
	<?php
	$award = get_sub_field('awards_award');
	$project = get_sub_field('awards_project');
	$show = get_sub_field('awards_show');
	?>
	<li><span class="award"><?php echo get_sub_field('awards_award') ?></span><?php if(!empty($project)): ?><span class="project"><?php echo $project ?></span><?php endif; ?><span class="show"><?php echo get_sub_field('awards_show') ?></span></li>
<?php endwhile; ?>
</ul>
<?php endif; ?>
</div>
