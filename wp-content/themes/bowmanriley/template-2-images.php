...
if(get_field('image_slider',$post->ID)):
  ?>
<div class="row height-50-pct gutter slider-container">
...
<?php else: ?>
  <div class="row height-50-pct bg-fill-cell masked" style="background-image:url('<?php echo wp_get_attachment_url(get_post_thumbnail_id($image_id)); ?>');">
...
<?php endif ?>
  <div class="row height-50-pct bg-fill-cell"  style="background-image:url('<?php echo wp_get_attachment_url(get_field('image_2_src',$post->ID)); ?>');">
