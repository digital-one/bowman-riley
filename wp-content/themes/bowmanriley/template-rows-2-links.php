...
<?php $class = !empty($form_id) ? 'fancybox' : 'push-link' ?>
 ...
 <?php else: ?>
  <div class="column width-40-pct">
 	<a href="<?php echo $permalink?>" target="<?php echo $target?>" class="<?php echo $class ?> fit-cell <?php echo $anchor_class ?> <?php echo $arrow_direction?> <?php echo get_field('theme',$post->ID)?>"><?php echo $label ?></a>
 </div>
<?php endif ?>
